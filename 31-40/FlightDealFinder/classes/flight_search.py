...
class FlightSearch:
    ...
    def __init__(self):
        load_dotenv()
        self._api_key = os.environ["AMADEUS_SEARCH_API_KEY"]
        self._api_secret = os.environ["AMADEUS_SEARCH_API_SECRET"]
    ...
    def getDestinationCode(self,cityName):
        """
        ...
        print(f'Status code {res.status_code}. Airport IATA: {res.text}')
        try:
